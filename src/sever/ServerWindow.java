...
public class ServerWindow extends JFrame {
    ...
    private final JButton btnStart = new JButton("Запуск сервера");
    private final JButton btnStop = new JButton("Остановка сервера");
    ...
    public ServerWindow() {
        ...
        btnStop.addActionListener(e -> {
            if (!isServerWorking) {
                logMessage("Сервер уже не активен");
            } else {
                stopServer();
            }
        });
    ...
    public void stopServer() {
        ...
        logMessage("Сервер остановлен. Клиенты отключены");
    }
    ...
    private void saveLogToFile(String message) {
        String filePath = "src/sever/log.txt";
